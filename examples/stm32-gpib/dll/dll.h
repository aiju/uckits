...
#define TermEOS 0x0400
#define SetEOI 0x0800
#define EOS8 0x1000

typedef int (__stdcall * GpibNotifyCallback_t)(int, int, int, long, void*);

long EXPORT __stdcall ibask    (int ud, int option, int * v);
long EXPORT __stdcall ibcac    (int ud, int v);
long EXPORT __stdcall ibclr    (int ud);
long EXPORT __stdcall ibcmd    (int ud, void * buf, long cnt);
long EXPORT __stdcall ibcmda   (int ud, void * buf, long cnt);
long EXPORT __stdcall ibconfig (int ud, int option, int v);
int           EXPORT __stdcall ibdev    (int boardID, int pad, int sad, int tmo, int eot, int eos);
long EXPORT __stdcall ibexpert (int ud, int option, void * Input, void * Output);
int           EXPORT __stdcall ibfindA  (char * udname);
int           EXPORT __stdcall ibfindW  (wchar_t * udname);
long EXPORT __stdcall ibgts    (int ud, int v);
long EXPORT __stdcall iblck    (int ud, int v, unsigned int LockWaitTime, void * Reserved);
long EXPORT __stdcall iblines  (int ud, short * result);
long EXPORT __stdcall ibln     (int ud, int pad, int sad, short * listen);
long EXPORT __stdcall ibloc    (int ud);
long EXPORT __stdcall ibnotify (int ud, int mask, GpibNotifyCallback_t Callback, void * RefData);
long EXPORT __stdcall ibonl    (int ud, int v);
long EXPORT __stdcall ibpct    (int ud);
long EXPORT __stdcall ibppc    (int ud, int v);
long EXPORT __stdcall ibrd     (int ud, void * buf, long cnt);
long EXPORT __stdcall ibrda    (int ud, void * buf, long cnt);
long EXPORT __stdcall ibrdfA   (int ud, char * filename);
long EXPORT __stdcall ibrdfW   (int ud, wchar_t * filename);
long EXPORT __stdcall ibrpp    (int ud, char * ppr);
long EXPORT __stdcall ibrsp    (int ud, char * spr);
long EXPORT __stdcall ibsic    (int ud);
long EXPORT __stdcall ibstop   (int ud);
long EXPORT __stdcall ibtrg    (int ud);
long EXPORT __stdcall ibwait   (int ud, int mask);
long EXPORT __stdcall ibwrt    (int ud, void * buf, long cnt);
long EXPORT __stdcall ibwrta   (int ud, void * buf, long cnt);
long EXPORT __stdcall ibwrtfA  (int ud, char * filename);
long EXPORT __stdcall ibwrtfW  (int ud, wchar_t * filename);
long EXPORT __stdcall Ibsta(void);
long EXPORT __stdcall Iberr(void);
long EXPORT __stdcall Ibcnt(void);
long EXPORT __stdcall ThreadIbsta(void);
long EXPORT __stdcall ThreadIberr(void);
long EXPORT __stdcall ThreadIbcnt(void);
void EXPORT __stdcall AllSpoll       (int boardID, short * addrlist, short * results);
void EXPORT __stdcall DevClear       (int boardID, short addr);
void EXPORT __stdcall DevClearList   (int boardID, short * addrlist);
void EXPORT __stdcall EnableLocal    (int boardID, short * addrlist);
void EXPORT __stdcall EnableRemote   (int boardID, short * addrlist);
void EXPORT __stdcall FindLstn       (int boardID, short * addrlist, short * results, int limit);
void EXPORT __stdcall FindRQS        (int boardID, short * addrlist, short * dev_stat);
void EXPORT __stdcall PPoll          (int boardID, short * result);
void EXPORT __stdcall PPollConfig    (int boardID, short addr, int dataLine, int lineSense);
void EXPORT __stdcall PPollUnconfig  (int boardID, short * addrlist);
void EXPORT __stdcall PassControl    (int boardID, short addr);
void EXPORT __stdcall RcvRespMsg     (int boardID, void * buffer, long cnt, int Termination);
void EXPORT __stdcall ReadStatusByte (int boardID, short addr, short * result);
void EXPORT __stdcall Receive        (int boardID, short addr, void * buffer, long cnt, int Termination);
void EXPORT __stdcall ReceiveSetup   (int boardID, short addr);
void EXPORT __stdcall ResetSys       (int boardID, short * addrlist);
void EXPORT __stdcall Send           (int boardID, short addr, void * databuf, long datacnt, int eotMode);
void EXPORT __stdcall SendCmds       (int boardID, void * buffer, long cnt);
void EXPORT __stdcall SendDataBytes  (int boardID, void * buffer, long cnt, int eot_mode);
void EXPORT __stdcall SendIFC        (int boardID);
void EXPORT __stdcall SendLLO        (int boardID);
void EXPORT __stdcall SendList       (int boardID, short * addrlist, void * databuf, long datacnt, int eotMode);
void EXPORT __stdcall SendSetup      (int boardID, short * addrlist);
void EXPORT __stdcall SetRWLS        (int boardID, short * addrlist);
void EXPORT __stdcall TestSRQ        (int boardID, short * result);
void EXPORT __stdcall TestSys        (int boardID, short * addrlist, short * results);
void EXPORT __stdcall Trigger        (int boardID, short addr);
void EXPORT __stdcall TriggerList    (int boardID, short * addrlist);
void EXPORT __stdcall WaitSRQ        (int boardID, short * result);
